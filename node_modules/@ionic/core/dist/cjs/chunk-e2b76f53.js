...
const iosTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./ios.transition-ed6da4d2.js')); });
const mdTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./md.transition-3f53dd3d.js')); });
