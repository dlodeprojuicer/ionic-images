...
class Popover {
    ...
    async present() {
        ...
        this.usersElement = await __chunk_8.attachComponent(this.delegate, container, this.component, ['popover-viewport', this.el['s-sc']], data);
        await __chunk_9.deepReady(this.usersElement);
    ...
    async dismiss(data, role) {
        ...
        if (shouldDismiss) {
            await __chunk_8.detachComponent(this.delegate, this.usersElement);
        }
