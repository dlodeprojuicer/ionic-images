...
const __chunk_6 = require('./chunk-31bc374f.js');
...
class Toast {
    ...
    __stencil_render() {
        ...
        return (__chunk_1.h("div", { class: wrapperClass }, __chunk_1.h("div", { class: "toast-container" }, this.renderButtons(startButtons, 'start'), __chunk_1.h("div", { class: "toast-content" }, this.header !== undefined &&
            ...
            __chunk_1.h("div", { class: "toast-message", innerHTML: __chunk_6.sanitizeDOMString(this.message) })), this.renderButtons(endButtons, 'end'))));
    }
